...
data class ToDoViewModel(val id: String,
                    ...
                    val status: String) {
    constructor(todo: ToDo, time: LocalDateTime = LocalDateTime.now()) : this(
        todo.id,
        todo.content,
        todo.dueDate?.convertDayToRange(time) ?: "",
 ...
 */
private fun LocalDateTime.convertDayToRange(current: LocalDateTime) : String {
